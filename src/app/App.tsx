...
export default function App() {
  ...
  const [chatMessages, setChatMessages] = useState([
    {
      sender: "ai",
      text: "Halo Nabil 👋 Aku asisten AI Calm.in. Ada cerita apa yang ingin kamu bagikan hari ini?",
    },
  ]);
  ...
  const handleSendChatMessage = async () => {
    ...
    setChatMessages((prev) => [
      ...prev,
      { sender: "ai", text: "Malie sedang berpikir..." },
    ]);
    ...
    try {
      ...
      const response = await fetch(
        "https://api.groq.com/openai/v1/chat/completions",
        {
          ...
          headers: {
            ...
            Authorization:
              "Bearer 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",
          },
          body: JSON.stringify({
      ...
      setChatMessages((prev) => [
        ...
        {
          sender: "ai",
          text: "Koneksiku ke server sedang terganggu. Bisa tolong kirim kembali pesanmu?",
        },
      ]);
    }
  };
  ...
  const features = [
    ...
    },
    {
      ...
      icon: HeartHandshake,
      title: "Psikolog",
      desc: "Bantuan profesional",
      action: () => setActiveModal("proHelp"),
    },
    {
      id: "meditate",
      icon: Wind,
  ...
  const explorePosts = [
    {
      ...
      likes: 342,
      caption:
        "Berjalan di alam bebas adalah salah satu cara terbaik untuk menjernihkan pikiran. Sempatkan waktu minimal 15 menit hari ini untuk menghirup udara segar dan fokus pada pernapasanmu. 🌿 #MentalHealth #SelfCare",
    },
    {
      id: 2,
      user: "Calm.in",
      avatar:
        "https://images.unsplash.com/photo-1506126613408-eca07ce68773?q=80&w=100&auto=format&fit=crop",
      time: "5 jam yang lalu",
      image:
        "https://images.unsplash.com/photo-1545205597-3d9d02c29597?q=80&w=600&auto=format&fit=crop",
      likes: 892,
      caption:
        "Menulis jurnal bukan tentang menyusun kalimat yang sempurna, tapi tentang membebaskan beban yang ada di kepalamu. Mulai tulis satu kalimat hari ini. 📖✨ #Journaling #Mindfulness",
    },
    {
      id: 3,
      ...
      likes: 1205,
      caption:
        "Tidak apa-apa jika hari ini kamu hanya bisa bertahan. Itu sudah pencapaian yang hebat. Teruslah melangkah, sekecil apapun itu. 💙 #YouAreEnough",
    },
  ];
              ...
              {currentTab === "weekly-detail" && (
                ...
                >
                  <button
                    ...
                    className="p-1.5 bg-secondary text-primary rounded-full hover:bg-primary hover:text-white transition-colors mr-3"
                  >
                    <ChevronLeft size={18} />
                  </button>
                  <h1 className="text-lg font-bold text-foreground tracking-tight flex-1 text-center pr-8">
                    Detail Evaluasi
                  </h1>
                </motion.div>
              )}
                    ...
                    <section>
                      <div className="bg-primary text-primary-foreground rounded-3xl p-6 relative overflow-hidden shadow-xl shadow-primary/20">
                        ...
                        <div className="relative z-10">
                          <span className="inline-block px-3 py-1 bg-white/10 rounded-full text-[11px] font-semibold tracking-wide uppercase mb-4 backdrop-blur-md">
                            Kutipan Hari Ini
                          </span>
                  ...
                  <div className="flex gap-4 px-4 py-4 overflow-x-auto hide-scrollbar bg-background border-b border-border">
                    {exploreStories.map((story) => (
                      <div
                        ...
                        onClick={() =>
                          toast(
                            `Membuka cerita dari ${story.user}...`,
                          )
                        }
              ...
              {navItems.map((item, index) => {
                ...
                return (
                  <React.Fragment key={item.id}>
                    ...
                    >
                      <div
                        className={`p-2.5 rounded-2xl transition-all duration-300 ${isActive ? "bg-primary text-white shadow-lg shadow-primary/25 scale-110" : "text-muted-foreground group-hover:bg-secondary group-hover:text-primary"}`}
                      >
                        <item.icon
                          size={isActive ? 24 : 22}
                          className={
              ...
              {activeModal === "addAgenda" && (
                <div className="p-6 pt-10">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 bg-secondary text-primary rounded-xl flex items-center justify-center">
                      <Calendar size={20} />
                    </div>
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Jadwalkan aktivitasmu hari ini
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full py-4 mt-2 bg-primary text-white font-bold rounded-2xl hover:bg-primary/90 flex items-center justify-center gap-2 transition-colors"
                    >
                  ...
                  {!isCalling ? (
                    <>
                      ...
                      <p className="text-sm text-muted-foreground mb-8">
                        {depressionStep === 0
                          ? "Apakah dalam 2 minggu terakhir kamu sering merasa putus asa, sangat sedih, atau berpikir menyakiti diri sendiri?"
                          : "Sistem mendeteksi adanya indikasi depresi berat. Kami akan segera menghubungkanmu dengan bantuan profesional."}
                      </p>
                      {depressionStep === 0 ? (
